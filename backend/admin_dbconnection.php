...
function random_str_generator ($len_of_gen_str){
	...
	$sql = "INSERT INTO milopartners3.verifyCode (
				email
				,code
				,create_date
				)
...
//	$mainNetCode = $_REQUEST["mainNetCode"];
    ...
    $emparray = array();
    $sql = "SELECT t1.email,t1.code,t1.create_date,CURDATE(),TIMESTAMPDIFF(DAY, t1.create_date, CURDATE()) AS DIFF_DAY FROM milopartners3.verifyCode t1 where email='".$email."'";
